...
function loadCurrentFlight() {
  ...
  .done(function (response) {
    ...
    /*var flightResults = {
      uDepTime: (Array.isArray(results[i].operationalTimes.estimatedGateArrival) && results[i].operationalTimes.estimatedGateArrival.length > 0 && hotels[i].awards[0].rating) || "N/A",
    };*/
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      var timeToDep = moment(uArrTime).diff(moment.utc(), "minutes");
      ...
      console.log("Time to departure: " + timeToDep);
