...
$(document).ready(function() {
  ...
  .done(function(response) {
    ...
    $.ajax({
    url: "/api/yelp/v3/businesses/search?categories=restaurants&location=" + depAirport + "&radius=805&limit=6&sort_by=rating&open_now=true",
    method: "GET",
      headers: {
